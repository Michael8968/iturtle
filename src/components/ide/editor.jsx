...
class Editor extends Component {
  ...
  componentDidMount() {
    const { showSearch, userName, classid } = this.props

    console.warn('this.props.classid : ', classid);
    this.provider = new WebrtcProvider(classid, this.ydoc)
